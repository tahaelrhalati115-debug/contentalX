...
// Use SESSION_SECRET from environment or fallback to default (NOT recommended for production)
...
// Configure session with environment-based secret
app.use(session({ 
...
app.listen(PORT, () => {
  ...
  if (SESSION_SECRET === 'dev-secret-change-me-in-production') {
